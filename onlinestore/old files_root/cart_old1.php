					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item submenu dropdown">
								...
								<ul class="dropdown-menu">
									<li class="nav-item"><a class="nav-link" href="manager/manager_login.php">Manager</a></li>
									<li class="nav-item"><a class="nav-link" href="users/customer_login.php">Customer</a></li>
...
<div class="cart-container">
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td><img src="<?php echo $product['product_image']; ?>" alt="<?php echo htmlspecialchars($product['product_name']); ?>" width="100"></td>
    ...
    <div class="cart-actions">
        <a href="continue_shopping.php" class="btn">Continue Shopping</a>
