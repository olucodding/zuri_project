				...
				<div class="col-lg-6">
					<div class="login_box_img">
						...
						<div class="hover">
							...
							<a class="primary-btn" href="users/register.php">Create an Account</a>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<form class="row login_form" action="customer_login.php" method="post" id="contactForm" novalidate="novalidate">
