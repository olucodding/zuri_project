...
<body>
	...
	<header class="header_area sticky-header">
							...
							<li class="nav-item submenu dropdown">
								<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
								 aria-expanded="false">MY ACCOUNT</a>
									...
									<li class="nav-item"><a class="nav-link" href="manager/customer_login.php">Customer</a></li>
									<li class="nav-item"><a class="nav-link" href="manager/tracking.php">Tracking</a></li>
        ...
        <button type="submit" class="btn">NOW</button><br><br>
