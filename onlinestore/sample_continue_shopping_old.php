...
// Fetch up to 40 products, divided into 5 categories
$query = "SELECT * FROM products WHERE product_status = 'active' LIMIT 40";
            ...
            <div class="col-md-3 mb-4">
                <div class="card product-item">
                    ...
                    <div class="card-body">
                        ...
                        <a href="new_view_product.php?id=<?php echo $product['product_id']; ?>" class="btn btn-secondary btn-block mt-2">View More</a>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
