...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($product) {
        ...
        header("Location: users/shopping_cart.php?success=" . urlencode('Product added to cart successfully!'));
        exit();
    } else {
        // If product is not found, show an error
        header("Location: sample_continue_shopping.php" . urlencode('Product not found.'));
        exit();
    }
} else {
